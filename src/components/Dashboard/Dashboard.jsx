...
export default function Dashboard() {
  ...
  const {
    totalIncome, totalExpensesReal, balanceReal,
  ...
  return (
    <div className="p-6 page-enter">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <SummaryCard title="Despesas Total" value={totalExpensesReal} icon={TrendingDown} color="text-red-600" sub={`CC: ${formatCurrency(totalAllCCExp)}`} />
        <SummaryCard title="Saldo Real" value={balanceReal} icon={Wallet} color={balanceReal >= 0 ? 'text-blue-600' : 'text-red-600'} sub={balanceReal >= 0 ? 'Positivo ✓' : 'Negativo !'} />
